  ...
  return (
    <div className="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
      <div className="px-4 py-2 bg-gray-200">
        <h1 className="truncate overflow-ellipsis text-gray-900 font-bold text-3xl uppercase">
          {props.title}
        </h1>
      ...
      <div className="flex justify-between px-5 py-3 bg-gray-900">
        <h1 className="text-gray-200 font-bold text-xl">{props.price}</h1>
